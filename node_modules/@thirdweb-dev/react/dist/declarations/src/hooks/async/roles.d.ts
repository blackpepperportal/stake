...
import type { Multiwrap, Role, SmartContract, Split, ValidContractInstance, Vote } from "@thirdweb-dev/sdk";
/** **********************/
/**         UTILS       **/
/** **********************/
/**
 ...
 * @internal
 */
export declare type RolesForContract<TContract extends ContractWithRoles> = TContract extends SmartContract ? Role | (string & {}) : NonNullable<Exclude<TContract, SmartContract>["roles"]>["roles"][number];
/** **********************/
/**     READ  HOOKS     **/
/** **********************/
/**
