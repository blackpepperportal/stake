...
const CHAIN_ID_TO_GNOSIS_SERVER_URL = {
  ...
  [sdk.ChainId.Rinkeby]: "https://safe-transaction.rinkeby.gnosis.io"
};
...
const chain = {
  ...
  rinkeby: {
    id: sdk.ChainId.Rinkeby,
    name: "Rinkeby",
    nativeCurrency: sdk.NATIVE_TOKENS[sdk.ChainId.Rinkeby],
  ...
  optimismTestnet: {
    id: sdk.ChainId.OptimismTestnet,
    name: "Optimism Kovan",
    nativeCurrency: sdk.NATIVE_TOKENS[sdk.ChainId.OptimismTestnet],
  ...
  arbitrumTestnet: {
    id: sdk.ChainId.ArbitrumTestnet,
    name: "Arbitrum Rinkeby",
    nativeCurrency: sdk.NATIVE_TOKENS[sdk.ChainId.ArbitrumTestnet],
...
function useSigner() {
  ...
  const [signer, getSigner] = wagmi.useSigner();
  const [account] = wagmi.useAccount();
  const [network] = wagmi.useNetwork();

  const _getSignerPromise = React.useRef(null);
  ...
  return ethers.Signer.isSigner(signer.data) ? signer.data : undefined;
}
...
const ThirdwebSDKProvider = _ref4 => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ThirdwebAuthConfigProvider, {
    value: authConfig,
...
function useSDKContext() {
  const ctx = React__default["default"].useContext(ThirdwebSDKContext);
...
function useChainId() {
  ...
  return (_useNetwork$0$data$ch = wagmi.useNetwork()["0"].data.chain) === null || _useNetwork$0$data$ch === void 0 ? void 0 : _useNetwork$0$data$ch.id;
}
...
function getContractAbi(input) {
  ...
  if (input.contractType !== "custom") {
    contractAbi = sdk.CONTRACTS_MAP[input.contractType].contractAbi;
  }
...
function getContractFromCombinedTypeAndCompilerMetadata(contractAddress, input, sdk) {
  ...
  invariant__default["default"](contractAbi, "could not resolve any ABI for contract".concat(contractAddress));
...
function useContractMetadata(contractAddress) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.metadata(contractAddress), async () => {
    ...
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$metadata = contract.metadata) === null || _contract$metadata === void 0 ? void 0 : _contract$metadata.get, "contract metadata is not available");
...
function useAllContractEvents(contract) {
  ...
  const queryClient = reactQuery.useQueryClient();
  const activeChainId = useActiveChainId();
  const cacheKey = React.useMemo(() => createCacheKeyWithNetwork(cacheKeys.contract.events.getAllEvents(contractAddress), activeChainId), [activeChainId, contractAddress]);
  React.useEffect(() => {
...
function useNFT(contract, tokenId) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.get(contractAddress, tokenId), async () => {
    ...
    invariant__default["default"](contract.get, "Contract instance does not support get");
    return convertResponseToNFTType(contract, await contract.get(ethers.BigNumber.from(tokenId || 0)));
  }, {
...
function useNFTs(contract, queryParams) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.query.all(contractAddress, queryParams), async () => {
    ...
    invariant__default["default"](contract, "No Contract instance provided");
    invariant__default["default"]((_contract$query = contract.query) === null || _contract$query === void 0 ? void 0 : _contract$query.all, "Contract instance does not support query.all");
...
function useTotalCirculatingSupply() {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.query.totalCirculatingSupply(contractAddress), () => {
    ...
    if (contract.featureName === "ERC721") {
      ...
      invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$query2 = contract.query) === null || _contract$query2 === void 0 ? void 0 : _contract$query2.totalCirculatingSupply, "Contract instance does not support query.totalCirculatingSupply");
      return contract.query.totalCirculatingSupply();
    }

    invariant__default["default"]((_contract$query3 = contract.query) === null || _contract$query3 === void 0 ? void 0 : _contract$query3.totalCirculatingSupply, "Contract instance does not support query.getTotalCount");
...
function useTotalCount(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.query.totalCount(contractAddress), () => {
    ...
    invariant__default["default"](contract, "No Contract instance provided");
    invariant__default["default"]((_contract$query4 = contract.query) === null || _contract$query4 === void 0 ? void 0 : _contract$query4.totalCount, "Contract instance does not support query.totalCount");
...
function useOwnedNFTs(contract, ownerWalletAddress) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.query.owned.all(contractAddress, ownerWalletAddress), async () => {
    ...
    if (contract.featureName === "ERC721") {
      ...
      invariant__default["default"]((_contract$query5 = contract.query) === null || _contract$query5 === void 0 ? void 0 : (_contract$query5$owne = _contract$query5.owned) === null || _contract$query5$owne === void 0 ? void 0 : _contract$query5$owne.all, "Contract instance does not support query.owned.all");
      return convertResponseToNFTTypeArray(contract, await contract.query.owned.all(ownerWalletAddress));
    }

    invariant__default["default"]((_contract$query6 = contract.query) === null || _contract$query6 === void 0 ? void 0 : _contract$query6.owned, "Contract instance does not support query.owned");
...
function useNFTBalance() {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.balanceOf(contractAddress, ownerWalletAddress, tokenId), () => {
    invariant__default["default"](contract, "No Contract instance provided");
    invariant__default["default"](contract.balanceOf, "Contract instance does not support balanceOf");
...
function useMintNFT(contract) {
  ...
  return reactQuery.useMutation(async data => {
    ...
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$mint = contract.mint) === null || _contract$mint === void 0 ? void 0 : _contract$mint.to, "contract does not support mint.to");
...
function useMintNFTSupply(contract) {
  ...
  return reactQuery.useMutation(async data => {
    ...
    invariant__default["default"](data.to, 'No "to" address provided');
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$mint2 = contract.mint) === null || _contract$mint2 === void 0 ? void 0 : _contract$mint2.additionalSupplyTo, "contract does not support mint.additionalSupplyTo");
...
function useTransferNFT(contract) {
  ...
  return reactQuery.useMutation(data => {
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : contract.transfer, "contract does not support transfer");
...
function useBurnNFT(contract) {
  ...
  return reactQuery.useMutation(async data => {
    ...
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : contract.burn, "contract does not support burn");
...
function useUnclaimedNFTSupply(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.drop.totalUnclaimedSupply(contractAddress), () => {
    invariant__default["default"](contract, "No Contract instance provided");
    invariant__default["default"](contract.totalUnclaimedSupply, "Contract instance does not support totalUnclaimedSupply");
...
function useClaimedNFTSupply(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.drop.totalClaimedSupply(contractAddress), () => {
    ...
    invariant__default["default"](contract.totalClaimedSupply, "Contract instance does not support totalClaimedSupply");
...
function useBatchesToReveal(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.drop.revealer.getBatchesToReveal(contractAddress), () => {
    ...
    invariant__default["default"](contract, "No Contract instance provided");
    invariant__default["default"]((_contract$drop = contract.drop) === null || _contract$drop === void 0 ? void 0 : (_contract$drop$reveal = _contract$drop.revealer) === null || _contract$drop$reveal === void 0 ? void 0 : _contract$drop$reveal.getBatchesToReveal, "Contract instance does not support drop.revealer.getBatchesToReveal");
...
function useClaimNFT(contract) {
  ...
  return reactQuery.useMutation(async data => {
    invariant__default["default"](data.to, 'No "to" address provided');
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : contract.claimTo, "contract does not support claimTo");
...
function useLazyMint(contract, onProgress) {
  ...
  return reactQuery.useMutation(async data => {
    ...
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$drop2 = contract.drop) === null || _contract$drop2 === void 0 ? void 0 : _contract$drop2.lazyMint, "contract does not support drop.lazyMint");
    let options;
...
function useDelayedRevealLazyMint(contract, onProgress) {
  ...
  return reactQuery.useMutation(async data => {
    ...
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$drop3 = contract.drop) === null || _contract$drop3 === void 0 ? void 0 : (_contract$drop3$revea = _contract$drop3.revealer) === null || _contract$drop3$revea === void 0 ? void 0 : _contract$drop3$revea.createDelayedRevealBatch, "contract does not support drop.revealer.createDelayedRevealBatch");
    let options;
...
function useRevealLazyMint(contract) {
  ...
  return reactQuery.useMutation(async data => {
    ...
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$drop4 = contract.drop) === null || _contract$drop4 === void 0 ? void 0 : (_contract$drop4$revea = _contract$drop4.revealer) === null || _contract$drop4$revea === void 0 ? void 0 : _contract$drop4$revea.reveal, "contract does not support drop.revealer.reveal");
...
function useTransferBatchToken(contract) {
  ...
  const queryClient = reactQuery.useQueryClient();
  return reactQuery.useMutation(data => {
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : contract.transferBatch, "contract does not support transferBatch");
...
function useActiveClaimCondition() {
  ...
  return useQueryWithNetwork(cacheKeys.extensions.claimConditions.getActive(contractAddress, tokenId), () => {
    ...
    invariant__default["default"](contract, "No Contract instance provided");
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$drop = contract.drop) === null || _contract$drop === void 0 ? void 0 : (_contract$drop$claim = _contract$drop.claim) === null || _contract$drop$claim === void 0 ? void 0 : (_contract$drop$claim$ = _contract$drop$claim.conditions) === null || _contract$drop$claim$ === void 0 ? void 0 : _contract$drop$claim$.getActive, "Contract instance does not support contract?.drop?.claim?.conditions.getActive");
...
function useClaimIneligibilityReasons() {
  ...
  return useQueryWithNetwork(cacheKeys.extensions.claimConditions.getClaimIneligibilityReasons(contractAddress, params, tokenId), () => {
    ...
    invariant__default["default"](contract, "No Contract instance provided");
    invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$drop7 = contract.drop) === null || _contract$drop7 === void 0 ? void 0 : (_contract$drop7$claim = _contract$drop7.claim) === null || _contract$drop7$claim === void 0 ? void 0 : _contract$drop7$claim.conditions.getClaimIneligibilityReasons, "Contract instance does not support claimConditions.getClaimIneligibilityReasons");
...
function useBalance(tokenAddress) {
  ...
  const signer = useSigner();
  const walletAddress = useAddress();
  const walletSDK = React.useMemo(() => {
    if (signer) {
      const rpcUrl = rpcUrlMap[chainId];
      return new sdk.UserWallet(signer, {
...
const Box = styled__default["default"].div(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral([""])));
...
const StyledSvg = styled__default["default"].svg(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  border-radius: 0.25em;\n  flex-shrink: 0;\n  ", "\n"])), props => props.boxSize ? "width: ".concat(props.boxSize, ";\n    height: ").concat(props.boxSize, ";") : "");
const iconMap = {
...
const MenuItemBase = styled__default["default"].li(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  display: flex;\n  padding: 0.75em 1em;\n  align-items: center;\n  gap: 0.5em;\n  font-size: 1em;\n\n  ", "\n\n  > svg {\n    flex-shrink: 0;\n  }\n"])), props => props.isSelectable ? "&:hover,\n  &[data-focus] {\n    cursor: pointer;\n    background: ".concat(color__default["default"](props.theme.colors.text).alpha(0.15).hexa(), ";\n  }") : "");
const MenuItem = _ref => {
  let {
    children,
    leftElement,
...
var _templateObject;
const Select = styled__default["default"].select(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  margin: -0.25em 0;\n  background: ", ";\n  color: ", ";\n  border: 1px solid\n    ", ";\n  border-radius: 0.25em;\n  padding: 0.25em;\n  width: 100%;\n  flex-shrink: 1;\n  font-size: 1em;\n  &:hover {\n    cursor: pointer;\n  }\n  &:focus {\n    outline: 2px solid ", ";\n  }\n  &:disabled {\n    cursor: not-allowed;\n  }\n"])), props => color__default["default"](props.theme.colors.background).alpha(0.85).hexa(), props => props.theme.colors.text, props => color__default["default"](props.theme.colors.text).alpha(0.25).hexa(), props => props.theme.colors.accent);
...
const SupportedNetworkSelect = _ref => {
  ...
  const deprecatedNetworks = React.useMemo(() => {
    ...
    }).filter(n => n.id === sdk.ChainId.Rinkeby);
  }, []);
  const testnets = React.useMemo(() => {
    return sdk.SUPPORTED_CHAIN_IDS.map(supportedChain => {
      return getChainFromChainId(supportedChain);
    }).filter(n => n.testnet && n.id !== sdk.ChainId.Rinkeby);
  }, []);
...
const ConnectWallet = _ref => {
  ...
  const address = useAddress();
  const mountedAddress = React.useMemo(() => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ThemeProvider, { ...themeProps,
    children: /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Button, {
        ...
        leftElement: requiresSignIn ? isLoading ? /*#__PURE__*/jsxRuntime.jsx(Spinner, {}) : /*#__PURE__*/jsxRuntime.jsx(fi.FiLock, {}) : mountedAddress && chainId && chainId in chainIdToCurrencyMap ? /*#__PURE__*/jsxRuntime.jsx(Icon, {
          boxSize: "1.5em",
          name: chainIdToCurrencyMap[chainId]
        }) : undefined,
        rightElement: requiresSignIn ? undefined : /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [connector && getIconForConnector(connector), /*#__PURE__*/jsxRuntime.jsx(fi.FiChevronDown, {
            style: {
        ...
        children: mountedAddress ? requiresSignIn ? /*#__PURE__*/jsxRuntime.jsx("span", {
          style: {
            whiteSpace: "nowrap"
          },
          children: "Sign in"
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(Box, { ...api.positionerProps,
          ...
          children: /*#__PURE__*/jsxRuntime.jsx(Menu, { ...api.contentProps,
            children: !api.isOpen ? null : mountedAddress ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [authConfig !== null && authConfig !== void 0 && authConfig.authUrl && !(user !== null && user !== void 0 && user.address) && !requiresSignIn ? /*#__PURE__*/jsxRuntime.jsx(MenuItem, { ...api.getItemProps({
                ...
                leftElement: isLoading ? /*#__PURE__*/jsxRuntime.jsx(Spinner, {}) : /*#__PURE__*/jsxRuntime.jsx(fi.FiLock, {}),
                onClick: async () => {
                ...
                leftElement: hasCopied ? /*#__PURE__*/jsxRuntime.jsx(fi.FiCheck, {
                  width: "1em",
                  height: "1em",
                  color: "#57ab5a"
                }) : /*#__PURE__*/jsxRuntime.jsx(fi.FiCopy, {
                  width: "1em",
                  height: "1em"
                }),
                onClick: () => {
                ...
                isSelectable: false,
                leftElement: network.loading ? /*#__PURE__*/jsxRuntime.jsx(Spinner, {}) : network.error ? /*#__PURE__*/jsxRuntime.jsx(fi.FiWifi, {
                  color: "#e5534b",
                  width: "1em",
                  height: "1em"
                }) : /*#__PURE__*/jsxRuntime.jsx(fi.FiWifi, {
                  width: "1em",
                  height: "1em"
                }),
                ...
                leftElement: /*#__PURE__*/jsxRuntime.jsx(fi.FiShuffle, {
                  width: "1em",
                  height: "1em"
                }),
                onClick: async () => {
                ...
                leftElement: /*#__PURE__*/jsxRuntime.jsx(fi.FiXCircle, {
                  width: "1em",
                  height: "1em"
                }),
                onClick: () => {
...
const Web3Button = _ref => {
  ...
  const mutation = reactQuery.useMutation(async () => {
    ...
    invariant__default["default"](contractQuery.contract, "contract is not ready yet");
  ...
  if (!address) {
    return /*#__PURE__*/jsxRuntime.jsx(ConnectWallet, { ...themeProps
    });
  }
...
exports.useActiveChainId = useActiveChainId;
...
exports.useAllContractEvents = useAllContractEvents;
...
exports.useBuiltinContract = useBuiltinContract;
...
exports.useContractAbi = useContractAbi;
exports.useContractCall = useContractCall;
exports.useContractCompilerMetadata = useContractCompilerMetadata;
exports.useContractData = useContractData;
exports.useContractEvents = useContractEvents;
exports.useContractFunctions = useContractFunctions;
