...
var contractsJs = require('@thirdweb-dev/contracts-js');
...
var ABI = require('@thirdweb-dev/contracts-js/dist/abis/TokenERC1155.json');
var ABI$1 = require('@thirdweb-dev/contracts-js/dist/abis/DropERC1155.json');
var ABI$2 = require('@thirdweb-dev/contracts-js/dist/abis/Marketplace.json');
var ABI$3 = require('@thirdweb-dev/contracts-js/dist/abis/Multiwrap.json');
var ABI$4 = require('@thirdweb-dev/contracts-js/dist/abis/TokenERC721.json');
var ABI$5 = require('@thirdweb-dev/contracts-js/dist/abis/DropERC721.json');
var ABI$6 = require('@thirdweb-dev/contracts-js/dist/abis/Pack.json');
var ABI$7 = require('@thirdweb-dev/contracts-js/dist/abis/SignatureDrop.json');
var ABI$8 = require('@thirdweb-dev/contracts-js/dist/abis/Split.json');
var ABI$9 = require('@thirdweb-dev/contracts-js/dist/abis/TokenERC20.json');
var ABI$a = require('@thirdweb-dev/contracts-js/dist/abis/DropERC20.json');
var ABI$b = require('@thirdweb-dev/contracts-js/dist/abis/VoteERC20.json');
...
var ABI__default = /*#__PURE__*/_interopDefault(ABI);
var ABI__default$1 = /*#__PURE__*/_interopDefault(ABI$1);
var ABI__default$2 = /*#__PURE__*/_interopDefault(ABI$2);
var ABI__default$3 = /*#__PURE__*/_interopDefault(ABI$3);
var ABI__default$4 = /*#__PURE__*/_interopDefault(ABI$4);
var ABI__default$5 = /*#__PURE__*/_interopDefault(ABI$5);
var ABI__default$6 = /*#__PURE__*/_interopDefault(ABI$6);
var ABI__default$7 = /*#__PURE__*/_interopDefault(ABI$7);
var ABI__default$8 = /*#__PURE__*/_interopDefault(ABI$8);
var ABI__default$9 = /*#__PURE__*/_interopDefault(ABI$9);
var ABI__default$a = /*#__PURE__*/_interopDefault(ABI$a);
var ABI__default$b = /*#__PURE__*/_interopDefault(ABI$b);
...
const JsonLiteral = zod.z.union([zod.z.string(), zod.z.number(), zod.z.boolean(), zod.z.null()]);
const JsonSchema = zod.z.lazy(() => zod.z.union([JsonLiteral, zod.z.array(JsonSchema), zod.z.record(JsonSchema)]));
const JsonObjectSchema = zod.z.record(JsonSchema);
const HexColor = zod.z.union([zod.z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, "Invalid hex color").transform(val => val.replace("#", "")), zod.z.string().length(0)]);
...
(function (ChainId) {
  ...
  ChainId[ChainId["OptimismTestnet"] = 69] = "OptimismTestnet";
 ...
 * @public
 */
const SUPPORTED_CHAIN_IDS = [exports.ChainId.Mainnet, exports.ChainId.Rinkeby, exports.ChainId.Goerli, exports.ChainId.Polygon, exports.ChainId.Mumbai, exports.ChainId.Fantom, exports.ChainId.FantomTestnet, exports.ChainId.Avalanche, exports.ChainId.AvalancheFujiTestnet, exports.ChainId.Optimism, exports.ChainId.OptimismTestnet, exports.ChainId.Arbitrum, exports.ChainId.ArbitrumTestnet, exports.ChainId.BinanceSmartChainMainnet, exports.ChainId.BinanceSmartChainTestnet];
...
const NATIVE_TOKENS = {
  ...
  [exports.ChainId.ArbitrumTestnet]: {
  ...
  [exports.ChainId.OptimismTestnet]: {
    name: "Kovan Ether",
    symbol: "KOR",
    decimals: 18,
    wrapped: {
...
const OptionalPropertiesInput = zod.z.union([zod.z.array(JsonObjectSchema), JsonObjectSchema]).optional();

/**
 * @internal
 */

const CommonTokenInput = zod.z.object({
  name: zod.z.union([zod.z.string(), zod.z.number()]).optional(),
  description: zod.z.string().nullable().optional(),
  image: storage.FileBufferOrStringSchema.nullable().optional(),
  external_url: storage.FileBufferOrStringSchema.nullable().optional()
}).catchall(zod.z.lazy(() => JsonSchema));
/**
 * @internal
 */
...
const CommonNFTInput = CommonTokenInput.extend({
  animation_url: storage.FileBufferOrStringSchema.optional(),
...
const CommonContractSchema = zod.z.object({
  ...
  image: storage.FileBufferOrStringSchema.optional(),
...
function getProviderForNetwork(network) {
  ...
  switch (network) {
    case "mumbai":
      return "https://polygon-mumbai.g.alchemy.com/v2/".concat(DEFAULT_API_KEY);

    case "rinkeby":
      return "https://eth-rinkeby.g.alchemy.com/v2/".concat(DEFAULT_API_KEY);

    case "goerli":
      return "https://eth-goerli.g.alchemy.com/v2/".concat(DEFAULT_API_KEY);

    case "polygon":
    case "matic":
      return "https://polygon-mainnet.g.alchemy.com/v2/".concat(DEFAULT_API_KEY);

    case "mainnet":
    case "ethereum":
      return "https://eth-mainnet.g.alchemy.com/v2/".concat(DEFAULT_API_KEY);

    case "optimism":
      // TODO test this RPC
      return "https://opt-mainnet.g.alchemy.com/v2/".concat(DEFAULT_API_KEY);
    ...
    case "arbitrum":
      // TODO test this RPC
      return "https://arb-mainnet.g.alchemy.com/v2/".concat(DEFAULT_API_KEY);

    case "arbitrum-testnet":
      // TODO test this RPC
      return "https://arb-rinkeby.g.alchemy.com/v2/".concat(DEFAULT_API_KEY);
    ...
    default:
      if (network.startsWith("http") || network.startsWith("ws")) {
        ...
        throw new Error("Unrecognized chain name or RPC url: ".concat(network));
      }
...
function getReadOnlyProvider(network, chainId) {
  try {
    ...
    if (match) {
      switch (match[1]) {
        case "http":
          return new ethers.providers.JsonRpcBatchProvider(network, chainId);
...
class TransactionError extends Error {
  constructor(reason, from, to, data, network, rpcUrl, raw, functionInfo) {
    ...
    builtErrorMsg += "Message: ".concat(reason);
    builtErrorMsg += "\n\n| Transaction info |\n";
    builtErrorMsg += withSpaces("from", from);
    builtErrorMsg += withSpaces("to", to);
    builtErrorMsg += withSpaces("chain", "".concat(network.name, " (").concat(network.chainId, ")"));
    ...
    if (functionInfo) {
      ...
      if (functionInfo.value.gt(0)) {
        ...
        builtErrorMsg += withSpaces("value", "".concat(ethers.ethers.utils.formatEther(functionInfo.value), " ").concat((_NATIVE_TOKENS = NATIVE_TOKENS[network.chainId]) === null || _NATIVE_TOKENS === void 0 ? void 0 : _NATIVE_TOKENS.symbol));
      }
    }
...
function withSpaces(label, content) {
  ...
  return "\n".concat(label, ":").concat(spaces).concat(content);
}
...
async function createSnapshot(snapshotInput, tokenDecimals, storage) {
  ...
  const hashedLeafs = input.map(i => hashLeafNode(i.address, ethers.utils.parseUnits(i.maxClaimable, tokenDecimals)));
  const tree = new MerkleTree__default["default"](hashedLeafs, ethers.utils.keccak256, {
    sort: true
  });
...
const FEATURE_EDITION_DROPPABLE = {
...
function extractFunctionParamsFromAbi(abi, functionName) {
  for (const input of abi) {
    if (input.type === "function" && input.name === functionName) {
      ...
      return (_input$inputs2 = input.inputs) !== null && _input$inputs2 !== void 0 ? _input$inputs2 : [];
    }
  }
...
function extractFunctionsFromAbi(abi, metadata) {
  ...
  for (const f of functions) {
    var _f$inputs, _f$inputs$map, _f$outputs, _f$outputs$map, _f$inputs2, _f$outputs2, _f$name, _f$stateMutability;

    const doc = extractCommentFromMetadata(f.name, metadata, "methods");
    const args = ((_f$inputs = f.inputs) === null || _f$inputs === void 0 ? void 0 : (_f$inputs$map = _f$inputs.map(i => "".concat(i.name || "key", ": ").concat(toJSType(i)))) === null || _f$inputs$map === void 0 ? void 0 : _f$inputs$map.join(", ")) || "";
    ...
    parsed.push({
      inputs: (_f$inputs2 = f.inputs) !== null && _f$inputs2 !== void 0 ? _f$inputs2 : [],
      outputs: (_f$outputs2 = f.outputs) !== null && _f$outputs2 !== void 0 ? _f$outputs2 : [],
...
function extractEventsFromAbi(abi, metadata) {
  ...
  for (const e of events) {
    var _e$inputs, _e$outputs, _e$name;
...
async function resolveContractUriFromAddress(address, provider) {
  ...
  if (bytecode.startsWith("0x363d3d373d3d3d363d")) {
    ...
    return resolveContractUriFromAddress("0x".concat(implementationAddress), provider);
...
function extractIPFSHashFromBytecode(bytecode) {
  ...
  const cborData = cborWeb.decodeFirstSync(bytecodeBuffer);

  if (cborData["ipfs"]) {
    return "ipfs://".concat(multihashes.toB58String(cborData["ipfs"]));
  }
...
async function fetchContractMetadataFromAddress(address, provider, storage) {
  ...
  if (!compilerMetadataUri) {
    throw new Error("Could not resolve metadata for contract at ".concat(address));
  }
...
async function fetchSourceFilesFromMetadata(publishedMetadata, storage) {
  return await Promise.all(Object.entries(publishedMetadata.metadata.sources).map(async _ref2 => {
    ...
    if (ipfsLink) {
      ...
      const source = await Promise.race([storage.getRaw("ipfs://".concat(ipfsHash)), timeout]);
      return {
        filename: path,
        source
      };
...
const BYOCContractMetadataSchema = CommonContractSchema.catchall(zod.z.lazy(() => JsonSchema));
/**
 * @internal
 */
...
const ExtraPublishMetadataSchemaInput = zod.z.object({
  ...
  audit: storage.FileBufferOrStringSchema.nullable().optional(),
  logo: storage.FileBufferOrStringSchema.nullable().optional(),
...
const ProfileSchemaInput = zod.z.object({
  ...
  avatar: storage.FileBufferOrStringSchema.nullable().optional(),
...
class WalletAuthenticator extends RPCConnectionHandler {
  ...
  verify(domain, payload, options) {
    ...
    if (payload.payload.domain !== domain) {
      throw new Error("Expected domain '".concat(domain, "' does not match domain on payload '").concat(payload.payload.domain, "'"));
    ...
    if ((parsedOptions === null || parsedOptions === void 0 ? void 0 : parsedOptions.chainId) !== undefined && parsedOptions.chainId !== payload.payload.chain_id) {
      throw new Error("Chain ID '".concat(parsedOptions.chainId, "' does not match payload chain ID '").concat(payload.payload.chain_id, "'"));
    ...
    if (userAddress.toLowerCase() !== payload.payload.address.toLowerCase()) {
      throw new Error("Signer address '".concat(userAddress.toLowerCase(), "' does not match payload address '").concat(payload.payload.address.toLowerCase(), "'"));
    }
  ...
  async generateAuthToken(domain, payload, options) {
    ...
    const token = "".concat(encodedHeader, ".").concat(encodedData, ".").concat(encodedSignature);
    return token;
  }
  /**
  ...
  async authenticate(domain, token) {
    ...
    if (payload.aud !== domain) {
      throw new Error("Expected token to be for the domain '".concat(domain, "', but found token with domain '").concat(payload.aud, "'"));
    ...
    if (connectedAddress.toLowerCase() !== payload.iss.toLowerCase()) {
      throw new Error("Expected the connected wallet address '".concat(connectedAddress, "' to match the token issuer address '").concat(payload.iss, "'"));
    ...
    if (connectedAddress.toLowerCase() !== adminAddress.toLowerCase()) {
      throw new Error("The connected wallet address '".concat(connectedAddress, "' did not sign the token"));
    }
  ...
  generateMessage(payload) {
    ...
    if (payload.chain_id) {
      message += "Chain ID: ".concat(payload.chain_id, "\n");
    }

    message += "Nonce: ".concat(payload.nonce, "\n");
    message += "Expiration Time: ".concat(payload.expiration_time, "\n");
    return message;
  }
...
class ContractRoles {
  ...
  async get(role) {
    invariant__default["default"](this.roles.includes(role), "this contract does not support the \"".concat(role, "\" role"));
    const wrapper = this.contractWrapper;
...
async function uploadOrExtractURIs(metadatas, storage, startNumber, contractAddress, signerAddress, options) {
  if (isUriList(metadatas)) {
    ...
    const {
      uris
    } = await storage.uploadMetadataBatch(metadatas.map(m => CommonNFTInput.parse(m)), startNumber, contractAddress, signerAddress, options);
    return uris;
  } else {
...
class DelayedReveal {
  ...
  async createDelayedRevealBatch(placeholder, metadatas, password, options) {
    var _this$contractWrapper, _this$contractWrapper2;
    ...
    const {
      baseUri: placeholderUri
    } = await this.storage.uploadMetadataBatch([CommonNFTInput.parse(placeholder)], 0, this.contractWrapper.readContract.address, await ((_this$contractWrapper = this.contractWrapper.getSigner()) === null || _this$contractWrapper === void 0 ? void 0 : _this$contractWrapper.getAddress()));
    const startFileNumber = await this.nextTokenIdToMintFn();
    const batch = await this.storage.uploadMetadataBatch(metadatas.map(m => CommonNFTInput.parse(m)), startFileNumber.toNumber(), this.contractWrapper.readContract.address, await ((_this$contractWrapper2 = this.contractWrapper.getSigner()) === null || _this$contractWrapper2 === void 0 ? void 0 : _this$contractWrapper2.getAddress()), options);
    const baseUri = batch.baseUri.endsWith("/") ? batch.baseUri : "".concat(batch.baseUri, "/");
    ...
    const receipt = await this.contractWrapper.sendTransaction("lazyMint", [batch.uris.length, placeholderUri.endsWith("/") ? placeholderUri : "".concat(placeholderUri, "/"), data]);
...
async function signEIP2612Permit(signer, currencyAddress, owner, spender, value, deadline, nonce) {
  ...
  nonce = (_nonce2 = nonce) !== null && _nonce2 !== void 0 ? _nonce2 : (await getSignerNonce(signer, currencyAddress)).toString();
  deadline = (_deadline2 = deadline) !== null && _deadline2 !== void 0 ? _deadline2 : ethers.ethers.constants.MaxUint256;
  const message = {
    owner,
    spender,
    value,
...
class ContractWrapper extends RPCConnectionHandler {
  ...
  async sendGaslessTransaction(fn) {
    ...
    let gas = gasEstimate.mul(2); // in some cases WalletConnect doesn't properly gives an estimate for how much gas it would actually use.
  ...
  async defenderSendFunction(transaction) {
    ...
    const forwarderAddress = this.options.gasless.openzeppelin.relayerForwarderAddress || CONTRACT_ADDRESSES[transaction.chainId].openzeppelinForwarder;
    const forwarder = contractsJs.Forwarder__factory.connect(forwarderAddress, provider);
  ...
  async getClaimIneligibilityReasons(tokenId, quantity, addressToCheck) {
    ...
    if (claimCondition.price.gt(0) && isNode()) {
      ...
      if (isNativeToken(claimCondition.currencyAddress)) {
        ...
        const erc20 = new ContractWrapper(provider, claimCondition.currencyAddress, contractsJs.IERC20__factory.abi, {});
        const balance = await erc20.readContract.balanceOf(addressToCheck);
...
class Erc20Droppable {
   ...
   */
  constructor(erc20, contractWrapper, storage) {
    _defineProperty(this, "featureName", FEATURE_TOKEN_DROPPABLE.name);
...
class Erc20 {
  ...
  constructor(contractWrapper, storage) {
    ...
    _defineProperty(this, "mint", void 0);

    _defineProperty(this, "burn", void 0);
...
class Erc721Claimable {
   ...
   */
  constructor(erc721, contractWrapper, storage) {
    _defineProperty(this, "featureName", FEATURE_NFT_CLAIMABLE.name);
  ...
  async getClaimTransaction(destinationAddress, quantity) {
    let checkERC20Allowance = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    let // TODO split up allowance checks
    claimData = arguments.length > 3 ? arguments[3] : undefined;
    let claimVerification = claimData;
    ...
    return TransactionTask.make({
      ...
      functionName: "claim",
      args: [destinationAddress, quantity, claimVerification.currencyAddress, claimVerification.price, {
  ...
  async to(destinationAddress, quantity) {
    let checkERC20Allowance = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    let claimData = arguments.length > 3 ? arguments[3] : undefined;
...
class Erc721Droppable {
   ...
   */
  constructor(erc721, contractWrapper, storage) {
    _defineProperty(this, "featureName", FEATURE_NFT_DROPPABLE.name);
  ...
  async lazyMint(metadatas, options) {
    ...
    const batch = await uploadOrExtractURIs(metadatas, this.storage, startFileNumber.toNumber(), this.contractWrapper.readContract.address, await ((_this$contractWrapper = this.contractWrapper.getSigner()) === null || _this$contractWrapper === void 0 ? void 0 : _this$contractWrapper.getAddress()), options); // ensure baseUri is the same for the entire batch
    ...
    const receipt = await this.contractWrapper.sendTransaction("lazyMint", [batch.length, baseUri.endsWith("/") ? baseUri : "".concat(baseUri, "/"), ethers.ethers.utils.toUtf8Bytes("")]);
...
class Erc721WithQuantitySignatureMintable {
  constructor(contractWrapper, storage) {
    _defineProperty(this, "featureName", FEATURE_NFT_SIGNATURE_MINTABLE.name);
...
class Erc1155Claimable {
  ...
  async getClaimTransaction(destinationAddress, tokenId, quantity) {
    ...
    let // TODO split up allowance checks
    claimData = arguments.length > 4 ? arguments[4] : undefined;
    let claimVerification = claimData;
    ...
    return TransactionTask.make({
      contractWrapper: this.contractWrapper,
      functionName: "claim",
      args: [destinationAddress, tokenId, quantity, claimVerification.currencyAddress, claimVerification.price, {
        proof: claimVerification.proofs,
        maxQuantityInAllowlist: claimVerification.maxQuantityPerTransaction
      }, ethers.ethers.utils.toUtf8Bytes("")],
      overrides: claimVerification.overrides
  ...
  async to(destinationAddress, tokenId, quantity) {
    let checkERC20Allowance = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    let claimData = arguments.length > 4 ? arguments[4] : undefined;
...
class Erc1155Droppable {
   ...
   */
  constructor(erc1155, contractWrapper, storage) {
    _defineProperty(this, "featureName", FEATURE_EDITION_DROPPABLE.name);
  ...
  async lazyMint(metadatas, options) {
    var _this$contractWrapper, _receipt;
    ...
    if (isLegacyEditionDropContract) {
      receipt = await this.contractWrapper.sendTransaction("lazyMint", [batch.length, "".concat(baseUri.endsWith("/") ? baseUri : "".concat(baseUri, "/"))]);
    } else {
      // new contracts/extensions have support for delayed reveal that adds an extra parameter to lazyMint
      receipt = await this.contractWrapper.sendTransaction("lazyMint", [batch.length, "".concat(baseUri.endsWith("/") ? baseUri : "".concat(baseUri, "/")), ethers.ethers.utils.toUtf8Bytes("")]);
    }
...
class Erc1155 {
  ...
  async airdrop(tokenId, addresses) {
    ...
    if (balanceOf.toNumber() < totalToAirdrop) {
      throw new Error("The caller owns ".concat(balanceOf.toNumber(), " NFTs, but wants to airdrop ").concat(totalToAirdrop, " NFTs."));
    }
...
class ContractRegistry extends ContractWrapper {
  constructor(registryAddress, network, options) {
    super(network, registryAddress, contractsJs.TWRegistry__factory.abi, options);
  }
...
class Edition extends Erc1155 {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, Edition.contractAbi, options);
    ...
    _defineProperty(this, "signature", super.signature);

    _defineProperty(this, "interceptor", void 0);

    _defineProperty(this, "_query", this.query);

    _defineProperty(this, "_mint", this.mint);

    _defineProperty(this, "_burn", this.burn);

    _defineProperty(this, "_batchMint", this._mint.batch);

    this.metadata = new ContractMetadata(this.contractWrapper, Edition.schema, this.storage);
...
_defineProperty(Edition, "contractType", "edition");

_defineProperty(Edition, "contractRoles", ["admin", "minter", "transfer"]);

_defineProperty(Edition, "contractAbi", ABI__default["default"]);

_defineProperty(Edition, "schema", TokenErc1155ContractSchema);
...
class EditionDrop extends Erc1155 {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    ...
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, EditionDrop.contractAbi, options);
    super(contractWrapper, storage, options);
    ...
    _defineProperty(this, "_drop", this.drop);

    _defineProperty(this, "_claim", (_this$drop = this.drop) === null || _this$drop === void 0 ? void 0 : _this$drop.claim);
    ...
    this.metadata = new ContractMetadata(this.contractWrapper, EditionDrop.schema, this.storage);
  ...
  async getClaimTransaction(destinationAddress, tokenId, quantity) {
    let checkERC20Allowance = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    const claimVerification = await this._claim.conditions.prepareClaim(tokenId, quantity, checkERC20Allowance);
    return TransactionTask.make({
      contractWrapper: this.contractWrapper,
      functionName: "claim",
      args: [destinationAddress, tokenId, quantity, claimVerification.currencyAddress, claimVerification.price, claimVerification.proofs, claimVerification.maxQuantityPerTransaction],
      overrides: claimVerification.overrides
    });
  }
  /**
  ...
  async claimTo(destinationAddress, tokenId, quantity) {
    let checkERC20Allowance = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    const tx = await this.getClaimTransaction(destinationAddress, tokenId, quantity, checkERC20Allowance);
    return await tx.execute();
  }
  /**
...
_defineProperty(EditionDrop, "contractType", "edition-drop");

_defineProperty(EditionDrop, "contractRoles", ["admin", "minter", "transfer"]);

_defineProperty(EditionDrop, "contractAbi", ABI__default$1["default"]);

_defineProperty(EditionDrop, "schema", DropErc1155ContractSchema);
...
class Marketplace {
  ...
  constructor(network, address, storage) {
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, Marketplace.contractAbi, options);
    ...
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.metadata = new ContractMetadata(this.contractWrapper, Marketplace.schema, this.storage);
  ...
  async getListing(listingId) {
    ...
    switch (listing.listingType) {
      case exports.ListingType.Auction:
        {
          return await this.auction.mapListing(listing);
        }

      case exports.ListingType.Direct:
        {
      ...
      default:
        {
          throw new Error("Unknown listing type: ".concat(listing.listingType));
        }
    }
  }
  /**
  ...
  async getActiveListings(filter) {
    ...
    return filtered.filter(l => {
      return l.type === exports.ListingType.Auction && ethers.BigNumber.from(l.endTimeInEpochSeconds).gt(now) && ethers.BigNumber.from(l.startTimeInEpochSeconds).lte(now) || l.type === exports.ListingType.Direct && l.quantity > 0;
    });
  }
  /**
  ...
  async isRestrictedToListerRoleOnly() {
    const anyoneCanList = await this.contractWrapper.readContract.hasRole(getRoleHash("lister"), ethers.constants.AddressZero);
  ...
  async buyoutListing(listingId, quantityDesired, receiver) {
    ...
    switch (listing.listingType) {
      ...
      default:
        throw Error("Unknown listing type: ".concat(listing.listingType));
    }
  }
  /**
  ...
  async allowListingFromSpecificAssetOnly(contractAddress) {
    ...
    if (members.includes(ethers.constants.AddressZero)) {
      encoded.push(this.encoder.encode("revokeRole", [getRoleHash("asset"), ethers.constants.AddressZero]));
    }
  ...
  async allowListingFromAnyAsset() {
    ...
    encoded.push(this.encoder.encode("grantRole", [getRoleHash("asset"), ethers.constants.AddressZero]));
    await this.contractWrapper.multiCall(encoded);
  }
  /** ******************************
   * PRIVATE FUNCTIONS
    ...
    const listings = await Promise.all(Array.from(Array((await this.contractWrapper.readContract.totalListings()).toNumber()).keys()).map(async i => {
      ...
      try {
        ...
        if (err instanceof ListingNotFoundError) {
          ...
          console.warn("Failed to get listing ".concat(i, "' - skipping. Try 'marketplace.getListing(").concat(i, ")' to get the underlying error."));
          return undefined;
        }
      }
  ...
  applyFilter(listings, filter) {
    ...
    const count = ethers.BigNumber.from((filter === null || filter === void 0 ? void 0 : filter.count) || DEFAULT_QUERY_ALL_COUNT).toNumber();
...
_defineProperty(Marketplace, "contractType", "marketplace");

_defineProperty(Marketplace, "contractRoles", ["admin", "lister", "asset"]);

_defineProperty(Marketplace, "contractAbi", ABI__default$2["default"]);

_defineProperty(Marketplace, "schema", MarketplaceContractSchema);
...
class Multiwrap extends Erc721 {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, Multiwrap.contractAbi, options);
    super(contractWrapper, storage, options);
    ...
    this.metadata = new ContractMetadata(this.contractWrapper, Multiwrap.schema, this.storage);
...
_defineProperty(Multiwrap, "contractType", "multiwrap");

_defineProperty(Multiwrap, "contractRoles", ["transfer", "minter", "unwrap", "asset"]);

_defineProperty(Multiwrap, "contractAbi", ABI__default$3["default"]);

_defineProperty(Multiwrap, "schema", MultiwrapContractSchema);
...
class NFTCollection extends Erc721 {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, NFTCollection.contractAbi, options);
    super(contractWrapper, storage, options);
    ...
    _defineProperty(this, "_owned", this._query.owned);

    this.metadata = new ContractMetadata(this.contractWrapper, NFTCollection.schema, this.storage);
...
_defineProperty(NFTCollection, "contractType", "nft-collection");

_defineProperty(NFTCollection, "contractRoles", ["admin", "minter", "transfer"]);

_defineProperty(NFTCollection, "contractAbi", ABI__default$4["default"]);

_defineProperty(NFTCollection, "schema", TokenErc721ContractSchema);
...
class NFTDrop extends Erc721 {
  ...
  constructor(network, address, storage) {
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, NFTDrop.contractAbi, options);
    super(contractWrapper, storage, options);
    ...
    this.metadata = new ContractMetadata(this.contractWrapper, NFTDrop.schema, this.storage);
  ...
  async getClaimTransaction(destinationAddress, quantity) {
    ...
    return TransactionTask.make({
      contractWrapper: this.contractWrapper,
      functionName: "claim",
      args: [destinationAddress, quantity, claimVerification.currencyAddress, claimVerification.price, claimVerification.proofs, claimVerification.maxQuantityPerTransaction],
      overrides: claimVerification.overrides
    });
  }
  /**
...
_defineProperty(NFTDrop, "contractType", "nft-drop");

_defineProperty(NFTDrop, "contractRoles", ["admin", "minter", "transfer"]);

_defineProperty(NFTDrop, "contractAbi", ABI__default$5["default"]);

_defineProperty(NFTDrop, "schema", DropErc721ContractSchema);
...
class Pack extends Erc1155 {
  ...
  constructor(network, address, storage) {
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, Pack.contractAbi, options);
    super(contractWrapper, storage, options);
    ...
    this.metadata = new ContractMetadata(this.contractWrapper, Pack.schema, this.storage);
  ...
  async isTransferRestricted() {
    const anyoneCanTransfer = await this.contractWrapper.readContract.hasRole(getRoleHash("transfer"), ethers.ethers.constants.AddressZero);
    return !anyoneCanTransfer;
  }
  /**
   * Get Pack Contents
  ...
  async createTo(to, metadataWithRewards) {
    ...
    const {
      contents,
      numOfRewardUnits
    } = await this.toPackContentArgs(parsedMetadata);
...
_defineProperty(Pack, "contractType", "pack");

_defineProperty(Pack, "contractRoles", ["admin", "minter", "pauser", "transfer"]);

_defineProperty(Pack, "contractAbi", ABI__default$6["default"]);

_defineProperty(Pack, "schema", PackContractSchema);
...
class SignatureDrop extends Erc721 {
  /**
   * @internal
   */
   ...
   */
  constructor(network, address, storage) {
    var _this$drop, _this$drop$claim, _this$drop2;

    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, SignatureDrop.contractAbi, options);
    super(contractWrapper, storage, options);
    ...
    _defineProperty(this, "claimConditions", (_this$drop = this.drop) === null || _this$drop === void 0 ? void 0 : (_this$drop$claim = _this$drop.claim) === null || _this$drop$claim === void 0 ? void 0 : _this$drop$claim.conditions);
    ...
    _defineProperty(this, "_claim", (_this$drop2 = this.drop) === null || _this$drop2 === void 0 ? void 0 : _this$drop2.claim);

    this.metadata = new ContractMetadata(this.contractWrapper, SignatureDrop.schema, this.storage);
...
_defineProperty(SignatureDrop, "contractType", "signature-drop");

_defineProperty(SignatureDrop, "contractRoles", ["admin", "minter", "transfer"]);

_defineProperty(SignatureDrop, "contractAbi", ABI__default$7["default"]);

_defineProperty(SignatureDrop, "schema", DropErc721ContractSchema);
...
class SmartContract {
  ...
  constructor(network, address, abi, storage) {
    ...
    _defineProperty(this, "edition", void 0);
    ...
    this.metadata = new ContractMetadata(this.contractWrapper, SmartContract.schema, this.storage); // feature detection
  ...
  async call(functionName) {
    ...
    if (fn.inputs.length !== args.length) {
      throw new Error("Function \"".concat(functionName, "\" requires ").concat(fn.inputs.length, " arguments, but ").concat(args.length, " were provided.\nExpected function signature: ").concat(fn.signature));
  ...
  detectRoyalties() {
    if (detectContractFeature(this.contractWrapper, "Royalty")) {
      ...
      const metadata = new ContractMetadata(this.contractWrapper, SmartContract.schema, this.storage);
...
_defineProperty(SmartContract, "contractType", "custom");

_defineProperty(SmartContract, "schema", CustomContractSchema);
...
class Split {
  ...
  constructor(network, address, storage) {
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, Split.contractAbi, options);
    ...
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.metadata = new ContractMetadata(this.contractWrapper, Split.schema, this.storage);
    this.encoder = new ContractEncoder(this.contractWrapper);
    this.estimator = new GasCostEstimator(this.contractWrapper);
    this.events = new ContractEvents(this.contractWrapper);
    this.interceptor = new ContractInterceptor(this.contractWrapper);
...
_defineProperty(Split, "contractType", "split");

_defineProperty(Split, "contractAbi", ABI__default$8["default"]);

_defineProperty(Split, "schema", SplitsContractSchema);
...
class Token extends Erc20 {
  ...
  constructor(network, address, storage) {
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, Token.contractAbi, options);
    super(contractWrapper, storage, options);
    ...
    this.metadata = new ContractMetadata(this.contractWrapper, Token.schema, this.storage);
...
_defineProperty(Token, "contractType", "token");

_defineProperty(Token, "contractRoles", ["admin", "minter", "transfer"]);

_defineProperty(Token, "contractAbi", ABI__default$9["default"]);

_defineProperty(Token, "schema", TokenErc20ContractSchema);
...
class TokenDrop extends Erc20 {
  ...
  constructor(network, address, storage) {
    ...
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, TokenDrop.contractAbi, options);
    super(contractWrapper, storage, options);
    ...
    this.metadata = new ContractMetadata(this.contractWrapper, TokenDrop.schema, this.storage);
...
_defineProperty(TokenDrop, "contractType", "token-drop");

_defineProperty(TokenDrop, "contractRoles", ["admin", "transfer"]);

_defineProperty(TokenDrop, "contractAbi", ABI__default$a["default"]);

_defineProperty(TokenDrop, "schema", DropErc20ContractSchema);
...
class Vote {
  ...
  constructor(network, address, storage) {
    let options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    let contractWrapper = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : new ContractWrapper(network, address, Vote.contractAbi, options);
    ...
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.metadata = new ContractMetadata(this.contractWrapper, Vote.schema, this.storage);
    this.encoder = new ContractEncoder(this.contractWrapper);
    this.estimator = new GasCostEstimator(this.contractWrapper);
    this.events = new ContractEvents(this.contractWrapper);
    this.interceptor = new ContractInterceptor(this.contractWrapper);
...
_defineProperty(Vote, "contractType", "vote");

_defineProperty(Vote, "contractAbi", ABI__default$b["default"]);

_defineProperty(Vote, "schema", VoteContractSchema);

/**
 * @internal
 */

const KNOWN_CONTRACTS_MAP = {
...
const CONTRACTS_MAP = { ...KNOWN_CONTRACTS_MAP,
...
const REMOTE_CONTRACT_TO_CONTRACT_TYPE = {
...
class ContractFactory extends ContractWrapper {
  constructor(factoryAddr, network, storage, options) {
    super(network, factoryAddr, contractsJs.TWFactory__factory.abi, options);
  ...
  async deploy(contractType, contractMetadata) {
    ...
    const contractURI = await this.storage.uploadMetadata(metadata, this.readContract.address, await ((_this$getSigner = this.getSigner()) === null || _this$getSigner === void 0 ? void 0 : _this$getSigner.getAddress()));
    const encodedFunc = ethers.Contract.getInterface(contract.contractAbi).encodeFunctionData("initialize", await this.getDeployArguments(contractType, metadata, contractURI));
    const contractName = REMOTE_CONTRACT_NAME[contractType];
    const encodedType = ethers.ethers.utils.formatBytes32String(contractName);
    let receipt;
  ...
  async getDeployArguments(contractType, metadata, contractURI) {
    let trustedForwarders = await this.getDefaultTrustedForwarders(); // override default forwarders if custom ones are passed in
    ...
    switch (contractType) {
      ...
      case Pack.contractType:
        ...
        return [await this.getSignerAddress(), packsMetadata.name, packsMetadata.symbol, contractURI, packsMetadata.fee_recipient, packsMetadata.seller_fee_basis_points];
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  static fromSigner(signer, network) {
    let options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    let storage$1 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : new storage.IpfsStorage();
  ...
  constructor(network) {
    ...
    let storage$1 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : new storage.IpfsStorage();
    const signerOrProvider = getProviderForNetwork(network);
    ...
    this.storage = new storage.RemoteStorage(storage$1);
  ...
  async resolveContractType(contractAddress) {
    const contract = contractsJs.IThirdwebContract__factory.connect(contractAddress, this.getSignerOrProvider());
    ...
    .replace(/\x00/g, "");
    invariant__default["default"](remoteContractType in REMOTE_CONTRACT_TO_CONTRACT_TYPE, "".concat(remoteContractType, " is not a valid contract type, falling back to custom contract"));
    ...
    const addressesWithContractTypes = await Promise.all(addresses.map(async address => {
      ...
      if (contractType === "custom") {
        try {
          ...
          console.warn("Couldn't get contract metadata for custom contract: ".concat(address));
        }
      } else {
...
class ContractDeployer extends RPCConnectionHandler {
  ...
  async deployReleasedContract(releaserAddress, contractName, constructorParams) {
    ...
    if (!release) {
      throw new Error("No release found for '".concat(contractName, "' by ").concat(releaserAddress));
    }
  ...
  async deployContractFromUri(publishMetadataUri, constructorParamValues) {
    ...
    if (isDeployableViaFactory && factoryDeploymentData) {
      ...
      invariant__default["default"](factoryDeploymentData.factoryAddresses, "factoryAddresses is required");
      ...
      invariant__default["default"](factoryAddress, "factoryAddress not found for chainId '".concat(chainId, "'"));
      invariant__default["default"](implementationAddress, "implementationAddress not found for chainId '".concat(chainId, "'"));
    ...
    const bytecode = compilerMetadata.bytecode.startsWith("0x") ? compilerMetadata.bytecode : "0x".concat(compilerMetadata.bytecode);
  ...
  convertParamValues(constructorParamTypes, constructorParamValues) {
    ...
    return constructorParamTypes.map((p, index) => {
      ...
      if (p === "bytes32") {
        invariant__default["default"](ethers.ethers.utils.isHexString(constructorParamValues[index]), "Could not parse bytes32 value. Expected valid hex string but got \"".concat(constructorParamValues[index], "\"."));
        return ethers.ethers.utils.hexZeroPad(constructorParamValues[index], 32);
      }

      if (p.startsWith("bytes")) {
        invariant__default["default"](ethers.ethers.utils.isHexString(constructorParamValues[index]), "Could not parse bytes value. Expected valid hex string but got \"".concat(constructorParamValues[index], "\"."));
...
exports.Erc1155Droppable = Erc1155Droppable;
...
exports.Erc721Claimable = Erc721Claimable;
exports.Erc721Droppable = Erc721Droppable;
...
exports.KNOWN_CONTRACTS_MAP = KNOWN_CONTRACTS_MAP;
...
exports.REMOTE_CONTRACT_NAME = REMOTE_CONTRACT_NAME;
exports.REMOTE_CONTRACT_TO_CONTRACT_TYPE = REMOTE_CONTRACT_TO_CONTRACT_TYPE;
