...
export declare const FEATURE_NFT_DROPPABLE: {
    readonly name: "ERC721Droppable";
    readonly namespace: "nft.drop";
    readonly docLinks: {
        readonly sdk: "sdk.erc721droppable";
